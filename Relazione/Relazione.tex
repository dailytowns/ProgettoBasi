...
\newpage
	...
	\begin{figure}[ht!]
		\resizebox{16cm}{!}{
			...
			\node[entity, below=30mm] (declinazione)[label={[right, xshift=-10mm, yshift=3mm](1,1)}] [below of=CoordDec] {Declinazione} edge (CoordDec);
			\node[attribute, left=20mm](DecSig) [below of=declinazione] {DecSig} edge (declinazione);
			\node[attribute, left=20mm](DecH) [below left of=declinazione] {Dech} edge (declinazione);
			\node[attribute, left=20mm](DecM) [left of=declinazione] {Decm} edge (declinazione);
			\node[attribute, left=20mm](DecS) [above left of=declinazione] {Decs} edge (declinazione);
			...
			\node[entity, below=100mm] (FlussoContHP) [below of = relazioneFlussoContHP] {FlussoRigheHP}  edge[label={[above right, yshift=10mm](1,1)}] (relazioneFlussoContHP);
...
\clearpage
	...
	\begin{figure}[h!]
		...
		\begin{class}[text width = 8cm]{GalaxyDAO}{10, -10}
		\operation{+searchGalaxyForRadius(Declination d, RightAscension ra, int n, double radius) : Galaxy}
		\end{class}
