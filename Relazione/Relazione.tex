...
\resizebox{15cm}{!}{
	\begin{tikzpicture}[node distance=7em]
		...
		\node[relationship, right=15mm] (riferisce) [right of=CaratteristicheGalassia] {riferisce} edge (CaratteristicheGalassia); 
		...
		\node[relationship, left=100mm] (relazioneFlusso) [below right of=Galassia] {misuraFlusso}; \draw (relazioneFlusso) |- (Galassia);
			...
			\node[relationship, right=100mm] (misuraFlusso) [right of=Flusso] {misuraFlusso} edge (Flusso);
				\node[entity, right=20mm] (valoreFlusso) [right of = misuraFlusso] {ValoreFlusso}  edge (misuraFlusso);
					\node[attribute, right=20mm] (valore) [right of=valoreFlusso] {Valore} edge (valoreFlusso); 
					\node[attribute] (erroreValore) [above right of=valoreFlusso] {Errore} edge (valoreFlusso);
					\node[attribute] (riferimento) [below right of=valoreFlusso] {Riferimento} edge (valoreFlusso);
\end{tikzpicture} 
}
\newpage
