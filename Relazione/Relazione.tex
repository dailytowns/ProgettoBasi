...
%		\begin{tabular}{lllll}
	...
	\begin{figure}[h]
		\resizebox{16cm}{!}{
			...
			\node[entity] (CaratteristicheGalassia) [below of = caratterizza] {CaratteristicheGalassia}  edge[label={[above right](1,1)}] (caratterizza);
			...
			\node[entity] (Errore) [below of = relazioneErrore] {Errore}  edge[label={[above right](1,1)}] (relazioneErrore);
			...
			\node[entity, right=20mm] (CoordinateAngolari) [right of = posizioneAngolare] {CoordinateAngolari}  edge[label={[above right](1,1)}] (posizioneAngolare);
			...
			\node[entity, below=120mm] (Flusso) [below of = relazioneFlusso] {Flusso}  edge[label={[above right](1,1)}] (relazioneFlusso);
				\node[attribute, left=10mm] (atomo) [left of=Flusso] {Atomo} edge (Flusso);
	...
	\begin{itemize}
		\item Nello schema gli archi in \textcolor{red}{rosso} indicano identificazione esterna
	\end{itemize}
