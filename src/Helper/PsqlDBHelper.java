...
public class PsqlDBHelper {
    ...
    public GalaxyData searchGalaxyForName(String nameGalaxy) {
        Statement stmt = null;
        ...
        try {
            ...
            String sign;
            CaratteristicheFisiche caratteristicheFisiche = null;
            ...
            galaxy = new GalaxyData(nome,redshift,caratteristicheFisiche,coordinateAngolari);
